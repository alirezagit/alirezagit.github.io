...
export default {
  error: {
    forgotPassword: {
      ...
      enterprise_email:
        'دامنه ایمیل شما سازمانی است. برای بازنشانی گذرواژه خود، لطفا به مدیر امنیتی خود مراجعه کنید'
    },
    login: {
      ...
      'lock.unauthorized': 'مجاز به ورود نشدید ، دوباره تلاش کنید',
      ...
      password_leaked:
        'اکانت شما به دلیل افشا شدن در وبسایت دیگری مسدود شده است ، ما مراحل رفع بلاک را برایتان ایمیل خواهیم کرد',
      too_many_attempts: 'اکانت شما به دلیل تلاش های نا موفق متوالی مسدود شده است',
      session_missing:
      ...
      too_many_requests:
        'متاسفیم. در حال حاضر درخواست های زیادی وجود دارد لطفا صفحه را مجددا بارگذاری کنید و دوباره تلاش کنید. اگر این مشکل ادامه داشت، لطفا بعدا دوباره امتحان کنید',
      invalid_captcha: 'حل چالش امنیتی برای تأیید اینکه ربات نیستید',
    ...
    signUp: {
      ...
      password_no_user_info_error: 'رمز عبور با اطلاعات کاربری مشابه است',
  ...
  enterpriseLoginIntructions: 'ورود با استفاده از اطلاعات سازمانی',
  ...
  forgotPasswordInstructions:
    'ایمیل خود را وارد کنید، ما ایمیلی برای تنظیم مجدد رمز عبور برایتان ارسال خواهیم کرد',
  ...
  loginAtLabel: '%s ورود در',
  loginLabel: 'ورود',
  loginSubmitLabel: 'ورود',
  loginWithLabel: '%s ورود با',
  ...
  passwordStrength: {
    ...
    numbers: 'اعداد (0-9)',
    lengthAtLeast: 'حداقل شامل %d حرف باید باشد',
